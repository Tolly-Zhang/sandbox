...
tf.WriteLine "$Host.UI.RawUI.WindowTitle = 'PDF Underlay - Normal'"
tf.WriteLine "Write-Host 'Normal mode. Paste or drag one or more PDFs into this window, then press Enter.' -ForegroundColor Cyan"
...
tf.WriteLine "else { & $scriptPath $input }"
tf.Close
